python ann.py --dataset IMAGENET --batch_size 128 --architecture mobilenetv3_small \
...
--spike_type 'sum' --bn_type 'bn' --start_spike_layer 0 --loss_type 'sum' --x_thr_scale 1.0 --weight_quantize 0 --use_hook \
--pretrained_ann 'ckpts/mbv3_small.pth.tar'

# torchrun --nproc_per_node=8 ann.py --dataset IMAGENET --batch_size 64 --im_size 224 --architecture mobilenetv3_small \
# --learning_rate 2e-1 --epochs 400 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
# --optimizer SGD --weight_decay 0.0005 --momentum 0.9 --amsgrad True --devices 0,1,2,3,4,5,6,7 --seed 0 --linear_dropout 0 --conv_dropout 0 \
# --net_mode 'ori' --pool_pos 'before_relu' --bn_type 'bn' --test_only \
# --spike_type 'sum' --loss_type 'sum' --hoyer_decay 2e-9 --start_spike_layer 0 --x_thr_scale 1.0 --weight_quantize 0 --test_type 'v1' \
# --pretrained_ann 'ckpts/mbv3_small.pth.tar'
