...
# torchrun --nproc_per_node=2 ann.py --dataset CIFAR10 --batch_size 128 --im_size 32 --architecture VGG16 \
...
torchrun --nproc_per_node=8 ann.py --dataset IMAGENET --batch_size 64 --im_size 224 --architecture VGG16 \
--learning_rate 0.005 --epochs 150 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
