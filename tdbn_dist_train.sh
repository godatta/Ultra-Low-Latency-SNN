...
--learning_rate 2e-02 --epochs 300 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
...
--act_mode 'fixed' --bn_type 'fake' --hoyer_type 'sum' --start_spike_layer 50 --conv_type 'dy' \
--description 'train tdbn with fake tdbn, use sum hoyer_thr replace thr' \
