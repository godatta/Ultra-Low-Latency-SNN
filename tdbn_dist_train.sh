...
torchrun --nproc_per_node=8 ann.py --dataset IMAGENET --batch_size 64 --im_size 224 --architecture RESNET18 \
--learning_rate 5e-4 --epochs 150 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
--optimizer Adam --weight_decay 0.0005 --momentum 0.9 --amsgrad True --devices 0,1,2,3,4,5,6,7 --seed 0 --linear_dropout 0 --conv_dropout 0 \
--net_mode 'ori' --log --pool_pos 'before_relu' --bn_type 'bn' \
--spike_type 'sum' --loss_type 'sum' --hoyer_decay 1e-8 --start_spike_layer 0 --x_thr_scale 1.0 --weight_quantize 0 \
--description 'test resnet18 sum, forward 2.0, , downsaple 2.0 with bn for bottleneck' --use_wandb --warmup 1000 --lr_decay 'step'