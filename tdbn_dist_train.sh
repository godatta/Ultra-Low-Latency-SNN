...
torchrun --nproc_per_node=4 ann.py --dataset IMAGENET --batch_size 32 --im_size 224 --architecture VGG16 \
--learning_rate 1e-1 --epochs 10 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
--optimizer SGD --weight_decay 0.0001 --momentum 0.9 --amsgrad True --devices 0,1,2,3 --seed 0 --linear_dropout 0.3 --conv_dropout 0.3 \
