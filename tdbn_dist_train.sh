...
# torchrun --nproc_per_node=4 ann_imagenet.py --dataset IMAGENET --batch_size 16 --im_size 224 --architecture VGG16 \
# --learning_rate 1e-4 --epochs 400 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
# --optimizer Adam --weight_decay 0.0001 --momentum 0.9 --amsgrad True --devices 0,1,2,3 --seed 0 --linear_dropout 0.1 --conv_dropout 0.1 \
...
# --description 'imagenet test without wandb' --use_wandb --warmup --lr_decay 'cos'
...
torchrun --nproc_per_node=8 ann.py --dataset IMAGENET --batch_size 16 --im_size 224 --architecture VGG16 \
--learning_rate 5e-2 --epochs 150 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
--optimizer SGD --weight_decay 0.00004 --momentum 0.9 --amsgrad True --devices 0,1,2,3,4,5,6,7 --seed 0 --linear_dropout 0.1 --conv_dropout 0.1 \
--net_mode 'ori' --log --pool_pos 'before_relu' --bn_type 'bn' \
--act_mode 'cw' --hoyer_type 'sum' --hoyer_decay 1e-8 --start_spike_layer 0 --x_thr_scale 1.0 --weight_quantize 0 \
--description 'imagenet test with wandb' --use_wandb --warmup --lr_decay 'cos'