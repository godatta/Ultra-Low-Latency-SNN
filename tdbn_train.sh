...
# --act_mode 'fixed' --bn_type 'bn' --hoyer_type 'sum' --start_spike_layer 50 --pooling_type 'max' \
# --description 'train tdbn with bn, with act loss, force 1 when > fixed_hoyer, pool before relu, maxpool, [0,1]bp' 
