...
--optimizer SGD --weight_decay 0.0005 --momentum 0.9 --amsgrad True --devices 0 --seed 0 --linear_dropout 0.3 --conv_dropout 0.1 \
--hoyer_decay 1e-8 --net_mode 'cut_2' --log \
--act_mode 'fixed' --bn_type 'fake' --hoyer_type 'sum' --start_spike_layer 50 \
--description  'train tdbn with fake tdbn, with act loss, spike when < fixed thr, cut 0.2, 0.8, fixed 0~2 bp' \
