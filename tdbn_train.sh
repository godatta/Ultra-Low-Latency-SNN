...
# --hoyer_decay 5e-9 --net_mode 'ori' --pool_pos 'before_relu'  --use_hook  --reg_thr --use_apex --log \
...
--optimizer SGD --weight_decay 0.0005 --momentum 0.9 --amsgrad True --devices 0,1 --seed 0 --linear_dropout 0 --conv_dropout 0 \
...
--description 'test resnet50 sum, bn after add' --use_hook  --use_wandb --reg_thr --warmup 1000 --lr_decay 'cos'
