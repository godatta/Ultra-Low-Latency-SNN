...
# --learning_rate 8e-4 --epochs 400 --lr_interval '0.60 0.80 0.90' --lr_reduce 5 --relu_threshold 1.0 \
# --optimizer Adam --weight_decay 0.0001 --momentum 0.9 --amsgrad True --devices 0,1,2,3,4,5,6,7 --seed 0 --linear_dropout 0 --conv_dropout 0 \
...
# torchrun --nproc_per_node=8 --master_port 29518 ann.py --dataset IMAGENET --batch_size 32 --im_size 224 --architecture VGG16 \
# --learning_rate 5e-2 --epochs 240 --lr_interval '0.50 0.75 0.85' --lr_reduce 5 --relu_threshold 1.0 \
# --optimizer SGD --weight_decay 4e-5 --momentum 0.9 --amsgrad True --devices 0,1,2,3,4,5,6,7 --seed 0 --linear_dropout 0 --conv_dropout 0 \
# --hoyer_decay 1e-8 --net_mode 'ori' --pool_pos 'before_relu'  --use_hook  --reg_thr --log \
# --spike_type 'cw' --bn_type 'bn' --loss_type 'sum' --start_spike_layer 0 --x_thr_scale 1.0 --weight_quantize 0 \
# --description 'resnet18 spike->conv->bn and bn first' --warmup 1000 --lr_decay 'step' --use_wandb 
