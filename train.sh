...
--optimizer Adam --weight_decay 0.0001 --momentum 0.9 --amsgrad True --devices 7 --seed 0 --linear_dropout 0.1 --conv_dropout 0.1 \
...
--description 'train a spike vgg16' --warmup 0 --lr_decay 'step' --use_hook --log --time_step 2
